...
# Private variables
obj = webrtcfd-signaling-server webrtcfd-signaling-client webrtcfd-signaling-management
...
depend:
	...
	docker exec -it webrtcfd-postgres bash -c 'until pg_isready; do sleep 1; done'
