...
func main() {
	...
	dev := flag.String("dev", "", "Name to give to the TAP device (i.e. weron0) (default is auto-generated)")
	mac := flag.String("mac", "", "MAC address to give to the TAP device (i.e. 3a:f8:de:7b:ef:52) (default is auto-generated)")
